...
<form onSubmit={handleLogin} className={style.loginForm}>
          ...
          {errors.password && <p className={style.errorText}>{errors.password}</p>}
            ...
            <button className={style.loginButton}>Login</button>
             ...
             <p><span style={{ textDecoration: 'underline', color: '#28A263', fontSize: '14px' }} >Forgot Password?</span></p>
            <p style={{ marginTop: '30px', fontSize: '13px', color: '#000000' }}> Don't have an account?{' '}
            <span style={{ textDecoration: 'underline', color: '#28A263', fontSize: '14px' }}  onClick={() => navigate("/signup")}>Sign up</span></p>
       </form>
